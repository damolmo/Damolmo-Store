      ...
      child: Stack(
        children: [
          ...
          Container(
            ...
            margin: EdgeInsets.only(
              left: getDeviceWidth(context) > 580 ? viewModel.app.appWebUrl.isEmpty ? getDeviceWidth(context) *  0.75 : getDeviceWidth(context) * 0.62 : kIsWeb ? getDeviceWidth(context) * 0.3 : 0.0,
