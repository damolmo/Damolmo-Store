...
class AboutAppScreenModel extends BaseViewModel implements Initialisable{
  ...
  List<String> aboutSubtitleString = ["v1.2.1+4", "${DateTime.now().year}/${DateTime.now().month}/${DateTime.now().day} ${DateTime.now().hour}:${DateTime.now().minute}:${DateTime.now().second}", kIsWeb ? "Web Browser" : "Android" ];
