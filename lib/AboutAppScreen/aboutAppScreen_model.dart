...
class AboutAppScreenModel extends HomeScreenModel implements Initialisable{
  ...
  List<String> aboutSubtitleString = ["v1.3.1+13", "${DateTime.now().year}/${DateTime.now().month}/${DateTime.now().day} ${DateTime.now().hour}:${DateTime.now().minute}:${DateTime.now().second}", kIsWeb ? "Web Browser" : "Android" ];
